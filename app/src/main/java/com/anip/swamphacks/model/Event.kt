...
{
    constructor() : this(12,name = "Anip",description = "",startTime = 1000, endTime = 1000, location = "", numAttendees = 0, type = "",map = "", avgRating = 0.5F, day = "",isVolunteer = false) // this constructor is an explicit
